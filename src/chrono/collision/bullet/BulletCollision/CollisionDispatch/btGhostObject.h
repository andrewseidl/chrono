...
public:
	...
	~btPairCachingGhostObject() override;

	///this method is mainly for expert/internal use only.
	void	addOverlappingObjectInternal(btBroadphaseProxy* otherProxy, btBroadphaseProxy* thisProxy=0) override;
