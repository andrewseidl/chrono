...
public:
	...
	void	setLocalScaling(const btVector3& scaling) override =0;
	const btVector3& getLocalScaling() const override =0;

	void	setMargin(btScalar margin) override =0;

	btScalar	getMargin() const override =0;
